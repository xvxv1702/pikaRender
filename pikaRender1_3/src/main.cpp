...
int APIENTRY wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow) {
	...
	while (1) {
		...
		//raster.shadeMode(memDC, &tex,  ldir, depthBuffer);//不提供法线贴图，兰伯特着色
		//raster.shadeMode(memDC, &tex, &normtex, ldir, depthBuffer);//提供法线贴图
		//raster.shadeMode(memDC, &tex, &normtex, &tan_normtex, ldir, depthBuffer);//提供法线题图、切线空间法线贴图，但是算起来太慢了
